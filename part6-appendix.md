# VMware Private AI Foundation 완벽 가이드 - Part 6
...
**권장:** PAIF 라이선스에 PAIS가 포함되어 있으므로, PAIS를 활용하는 것이 기본입니다. DLVM은 모델 평가, 실험, 커스텀 개발 등 **보조 목적**으로 사용합니다.
...
│               ├── DLVM 이미지 ← 포함                                        │
│               └── NVIDIA AI Enterprise 컴포넌트 ← 포함                      │
│                                                                             │
│   💡 PAIF 라이선스에 PAIS가 포함되어 있으므로 별도 구매 불필요              │
│                                                                             │
│   추가로 필요한 것:                                                         │
│   • NVIDIA vGPU 라이선스 (GPU 하드웨어 사용 시)                            │
